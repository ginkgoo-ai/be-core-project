...
@Tag(name = "Talent Scraper", description = "APIs for scraping talent profiles from various sources")
...
public class TalentScraperController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully scraped and saved talent profile",
...
//        String workspaceId = WorkspaceContext.getWorkspaceId(); 
    ...
    @Operation(summary = "Scrape talent profile from Spotlight",
            description = "Fetches talent information from Spotlight URL and saves it to database")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully scraped and saved talent profile",
                    content = @Content(schema = @Schema(implementation = Talent.class))),
    ...
    public ResponseEntity<TalentProfileResponse> scrapeSpotlightProfile(
            @Parameter(description = "Spotlight profile URL", required = true,
