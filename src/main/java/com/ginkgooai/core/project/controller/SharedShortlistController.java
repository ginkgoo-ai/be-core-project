...
public class SharedShortlistController {
        ...
        public ResponseEntity<ShortlistItemResponse> getShortlistItemById(
                        @Parameter(description = "ID of the shortlist item", required = true, example = "abc12345-1234-5678-90ab-1234567890ab") @PathVariable String shortlistItemId) {

                return ResponseEntity.ok(shortlistService.getShortlistItemById(shortlistItemId));
        }
